...
class PrismVisitController extends Notifier<PrismVisit> {
  ...
  late PrismMachineSession session;
  String _userId = '';
  int _version = 0;
  Timer? _timer;
  ...
  Future<void> load(String code, PrismMachineSession value) async {
    _version++;
    _timer?.cancel();
    shopCode = code;
    session = value;
  ...
  Future<void> refresh() async {
    ...
    try {
      ...
      if (userId == null) {
        throw const PrismException('请先登录', code: 'AUTHENTICATION_REQUIRED');
      }
