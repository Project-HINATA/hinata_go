...
const session = PrismMachineSession(
  ticket: 'test',
  expiresIn: 300,
  machine: PrismMachine(publicId: 'test', name: '舞萌 DX', shopName: '月宫'),
);
const card = PrismCard(
  id: '1',
  label: '一张名称比较长的测试卡片',
...
Widget content({
  ...
  String? passkeyLabel,
  bool success = false,
  List<PrismCard> cards = const [],
  ValueChanged<PrismCard>? onLogin,
}) => PrismMachineContent(
  session: PrismMachineSession(
