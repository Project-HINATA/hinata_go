...
import 'package:hinata_go/providers/prism_visit_provider.dart';
import 'package:hinata_go/services/arcadelink_api.dart';
import 'package:hinata_go/features/arcadelink/prism_visit_content.dart';
...
void main() {
  ...
  const machine = ArcadeLinkMachine(
    publicId: 'device',
    name: 'Device',
    shopName: 'Store',
    machineGeo: false,
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await http.runWithClient(
        () async {
          router.go('/arcadelink/store/device');
