...
void main() {
  group('TUnion Data & Lookup Tests', () {
    ...
    test('lookupTUnionStation matches Luoyang and Dalian Metro and Bus', () {
      ...
      // Luoyang Bus (2453 / 244B) - decoded using Luoyang's custom rule (first 2 chars hex -> 0x24 = 36)
      ...
      expect(luoyangBus1.line, '36路');
      expect(luoyangBus1.formatted, '[洛阳公交] 36路');
      ...
      expect(luoyangBus2.line, '36路');
      expect(luoyangBus2.formatted, '[洛阳公交] 36路');
