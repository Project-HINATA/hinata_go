...
// Compile with the ios/PrismClip/*.swift sources except PrismClipApp.swift.
...
// Other scenes mock all Prism requests. state-checks verifies recovery/stale responses.
import SwiftUI
import Foundation
