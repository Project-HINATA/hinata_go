## hinata_go local changes

* Add opt-in iOS handling for mixed ISO 14443/FeliCa detection results.
* Allow callers to skip the iOS NDEF capability query for emulated tags.
